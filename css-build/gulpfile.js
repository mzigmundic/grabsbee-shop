...
gulp.task("lint:css", function () {
    return gulp.src(config.css.inputPathAll).pipe(
        gulpStylelint({
...
gulp.task("css:watch:dev", function () {
    return gulp.watch(config.css.inputPathAll, gulp.series("css:compile:dev"));
});

gulp.task("css:watch:prod", function () {
    return gulp.watch(config.css.inputPathAll, gulp.series("css:compile:prod"));
});
...
gulp.task("prod", gulp.series("css:compile:prod"));
